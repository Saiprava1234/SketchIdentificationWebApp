...
document.getElementById("Sketchtobedrawn").innerHTML = '<p id="Sketchtobedrawn">Sketch To Be Drawn: ' + Element_of_array + '</p>';
...
function draw(){
    ...
    //If we have pressed the mouse, then draw line from PREVIOUS X & Y PoSiTiOn of moUSe to CURRENT X & Y PoSiTiOn of moUSe
    if(mouseIsPressed){
